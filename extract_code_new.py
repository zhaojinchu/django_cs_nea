...
project_dir = '/home/zhaojin/my_projects/cs_neaV2/cs_nea'  # Update this path to point to your project directory
...
exclude_files = ['db.sqlite3', 'extracted_code']  # Database file to exclude
